...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <img src="img/logo4.png"  style="width:45px;height:10px>
          ...
          <li class="nav-item">
          <a class="nav-link" href="https://docs.google.com/forms/d/e/1FAIpQLSctaDTjQqSyhjss4mljhO4vzuYZeyxA75Ji1n6OdlU-Y92Myw/viewform?usp=sf_link">Feedback</a>
        </li>
