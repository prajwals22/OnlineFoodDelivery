...
<div class="contact2" style="background-image:url(img/contactbg.jpg);height: 400px;" id="contact">
    <div class="container">
                                ...
                                <form action="partials/_manageContactUs.php" method="POST">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group mt-3">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email"
                                                       placeholder="Enter Your Email" required value="<?php echo isset($email) ? $email : '' ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mt-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="tel" class="form-control" id="phone" name="phone"
                                                           ...
                                                           pattern="[0-9]{10}" value="<?php echo isset($phone) ? $phone : '' ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mt-3">
                                                ...
                                                <input class="form-control" type="text" id="orderId" name="orderId"
                                                       placeholder="Order Id" value="0">
                                                <small id="orderIdHelp" class="form-text text-muted">If your problem
                                                    is not related to the order(order id = 0).
                                                </small>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <?php if($loggedin && isset($userId)) { ?>
                                            <div class="col-lg-12">
                                                <button type="submit"
                                                        class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT
                                                        NOW <i class="ti-arrow-right"></i></span></button>
                                                <button type="button"
                                        ...
                                        <?php } else { ?>
                                            <div class="col-lg-12">
                                                <button type="submit"
                                                        ...
                                                        disabled><span> SUBMIT NOW <i class="ti-arrow-right"></i></span>
                                                </button>
                                                <small class="form-text text-muted">First login to Contact with Us.
                                                </small>
                                            </div>
                                        <?php } ?>
                                    </div>
